...
#source climate and plotting files
#source("~/Documents/research/FunCaB/figures/plotting_dim.R")
#source("~/Documents/research/FunCaB/climate/LT_climate.R")

# load SPEI data
load("~/OneDrive - University of Bergen/Research/FunCaB/Data/secondary/spei_20092019.RData")

#load seedling and biomass data
